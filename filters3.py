...
def plot_filters():
    ...
    for bessellfilter in filters:
        wavelength  = ( 3000.+(9200.-3000.) * 
                numpy.array(range(n+1))/n) | units.angstrom
...
if __name__=="__main__":
    ...
    print fb
    print (fb*(1.| units.RSun)**2 / 
            (1.| units.AU)**2).in_(units.W/units.m**2)
    print (energy_flux2(5778.|units.K) * 
            (1.| units.RSun)**2/(1.| units.AU)**2).in_(units.W/units.m**2)
